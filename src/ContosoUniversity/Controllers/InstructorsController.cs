...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, int? courseID)
        {
            ...
            if (courseID != null)
            {
                ViewData["CourseID"] = courseID.Value; viewModel.Enrollments = viewModel.Courses.Where(
        ...
        public async Task<IActionResult> Edit(int? id, string[] selectedCourses)
        {
            ...
            i => i.FirstMidName, i => i.LastName, i => i.HireDate, i => i.OfficeAssignment))
            {
                ...
                UpdateInstructorCourses(selectedCourses, instructorToUpdate); try
                {
                    await _context.SaveChangesAsync();
                }
        ...
        private void UpdateInstructorCourses(string[] selectedCourses, Instructor instructorToUpdate)
        {
            ...
            var selectedCoursesHS = new HashSet<string>(selectedCourses); var instructorCourses = new HashSet<int>
            (instructorToUpdate.Courses.Select(c => c.Course.CourseID)); foreach (var course in _context.Courses)
            {
