...
namespace ContosoUniversity.Controllers
{
    ...
    public class TutorialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Description,Name,Price,StartDate")] Tutorial tutorial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description,Name,Price,StartDate")] Tutorial tutorial)
        {
            if (id != tutorial.ID)
            {
                return NotFound();
